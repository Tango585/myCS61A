...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    if num_rolls == 0:
        player_score = boar_brawl(player_score, opponent_score) + player_score
        return sus_points(player_score)
    temp_sus_update = roll_dice(num_rolls, dice) + player_score
    return sus_points(temp_sus_update)
    # END PROBLEM 4
